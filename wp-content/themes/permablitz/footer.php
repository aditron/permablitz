			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half">
							<a href="<?php echo get_bloginfo('url'); ?>"><img id="footer-logo" src="http://www.permablitz.net/wp-content/uploads/2015/05/footer_logo.png" width="166" height="46" alt="Permablitz Melbourne"></a>
						
						<div id="copyright">
							<?php if ( ot_get_option( 'copyright' ) ): ?>
								<p><?php echo esc_attr( ot_get_option( 'copyright' ) ); ?></p>
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo date( 'Y' ); ?>. <?php _e( 'Open source. All the way.', 'hueman' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
