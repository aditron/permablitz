...
class AlxPbPosts extends WP_Widget {

/*  Constructor
/* ------------------------------------ */

public function __construct() {
		parent::__construct( false, 'AlxPbPosts', array('description' => 'Display posts from a category', 'classname' => 'widget_alx_posts') );
	}
	...
	<ul class="alx-posts group <?php if($instance['posts_thumb']) { echo 'thumbs-enabled'; } ?>">
		...
		<li>
			...
			<div class="post-item-inner group">
				...
				<?php if($instance['posts_date']) { ?><p class="post-item-date"><?php the_date(); ?></p><?php } ?>
			</div>
