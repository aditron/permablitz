 ...
 */
class Pbz_Widget extends WP_Widget {
    ...
    function __construct() {
		parent::__construct( false, 'Events', array('description' => 'Display a list of events on Events Manager with class option.', 'classname' => 'dbem') );
//	}

 //   function Pbz_Widget() {
    	$this->defaults = array(
    		'title' => __('Events with Class Option','dbem'),
    		'class' => '',
    		'scope' => 'future',
    		'order' => 'ASC',
    		'limit' => 5,
    	...
    	$widget_ops = array('description' => __( "Display a list of events on Events Manager with class option.", 'dbem') );
    ...
    function widget($args, $instance) {
		...
		//get events
		$events = EM_Events::get(apply_filters('Pbz_Widget_events_get_args',$instance));
    ...
    function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('class'); ?>"><?php esc_html_e('UL Class', 'dbem'); ?>: </label>
			<input type="text" id="<?php echo $this->get_field_id('class'); ?>" name="<?php echo $this->get_field_name('class'); ?>" value="<?php echo esc_attr($instance['class']); ?>" class="widefat" />
		</p>
		<p>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('order'); ?>" name="<?php echo $this->get_field_name('order'); ?>" class="widefat">
				<?php 
				$order_options = apply_filters('Pbz_Widget_order_ddm', array(
...
add_action('widgets_init', create_function('', 'return register_widget("Pbz_Widget");'));
?>