...
?>	
<form enctype='multipart/form-data' id="event-form" method="post" action="<?php echo esc_url(add_query_arg(array('success'=>null))); ?>" class="frm_forms  with_frm_style frm_style_formidable-style">
	<div class="wrap frm_form_fields ">
		...
		<!-- <p>For best results, please ensure your image is at least 1024x768px (width by height).</p> -->
	...
	<input type="hidden" name="event_categories[]" value="58" />
