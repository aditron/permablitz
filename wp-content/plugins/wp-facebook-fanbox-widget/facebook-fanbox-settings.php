...
function ViFbFanBox_fb_like_bx_settings_page() {
     ...
     <div class="fb_like_bx_wrap">
          ...
          <div class="postbox settings_wrap left">
               ...
               <h3 class="hndle" style="padding:10px;"><?php _e("Facebook Like Box Settings", "viva-fb-fanbox") ?></h3>
               <div class="inside">
     ...
     <?php _e('Our Top 5 Latest Plugins', 'wvpd'); ?>:
                         ...
                         <div class="bottom">
                              ...
                              <div id="donateheretbl-comments-wvpd" class="togglediv">  
                                   ...
                                   <a href="http://vivacityinfotech.net/paypal-donation/" target="_blank"><img class="donate" src="<?php echo plugins_url('images/paypal.gif', __FILE__); ?>" width="150" height="50" title="<?php _e('Donate Here', 'wvpd'); ?>"></a>		
                              </div> 
                         </div>	
                         <div class="bottom">
                              ...
                              <div id="donateheretbl-comments-wvpd" class="togglediv">  
                                   ...
                                   <a href="http://vivacityinfotech.net/paypal-donation/" target="_blank"><img class="donate" src="<?php echo plugins_url('images/woo_frontend_banner.png', __FILE__); ?>" width="336" height="280" title="<?php _e('Donate Here', 'wvpd'); ?>"></a>		
                              </div> 
                         </div>
                         <div class="bottom">
                              ...
                              <div id="donateheretbl-comments-wvpd" class="togglediv">  
                                   <p class="p_content_left"><?php _e('If you want to purchase , please click on below image.', 'wvpd'); ?></p>
                                   <a href="http://vivacityinfotech.net/paypal-donation/" target="_blank"><img class="donate" src="<?php echo plugins_url('images/blue_frog_banner.png', __FILE__); ?>" width="336" height="280" title="<?php _e('Donate Here', 'wvpd'); ?>"></a>		
                              </div> 
                         </div>
                    </center>
...
function ViFbFanBox_fb_admin_init_menu() {
     ...
     add_submenu_page('viva_plugins', 'Facebook FanBox Settings', 'Facebook FanBox', 'manage_options', "fb_box_settings", 'ViFbFanBox_fb_like_bx_settings_page');
}
