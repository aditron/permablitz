...
<?php else : ?> 
	<?php _e('For promotion purposes, please add the largest image you can - at least 1200px x 720px (width by height) and no larger than 4MB. <br/>This will be used on the website and email updates.', 'dbem') ?>
<?php endif; ?>
</p>
