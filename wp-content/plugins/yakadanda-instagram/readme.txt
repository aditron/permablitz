...
= 0.1.9 =
* Change OAuth redirect_uri to prevent 404
* Not connected issue https://wordpress.org/support/topic/not-connected-2
* Add cache feature
* Update qTip
...
= 0.2.3 =
* Fix enqueue hook for frontend

= 0.2.2 =
* Fix transient name, for better cache feature
